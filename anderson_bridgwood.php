...
$twig = init_twig();
include('include/data1-categ2.php');
...
echo $twig->render('categorie2.twig', [
    ...
    'image2' => ['url'=>'mary_charlotte1.jpg', 'alt'=>'image1_Les_Inventrices'],
    'image3'=>['url'=>'mary_charlotte2.jpg', 'alt'=>'image2_Les_Inventrices'],
    'inventions'=>$inventions_anderson_bridgwood,
    'biographie' => $biographie_anderson_bridgwood,
    'page'=>$page,
	'footer'=>$footer

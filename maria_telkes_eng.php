...
echo $twig->render('categorie2.twig', [
    ...
    'image2' => ['url'=>'maria_telkes1.jpg', 'alt'=>'image1_Les_Inventrices'],
    'image3'=> ['url'=>'maria_telkes2.jpg', 'alt'=>'image2_Les_Inventrices'],
    'inventions'=>$inventions_telkes,
    'biographie' => $biographie_telkes,
    'page'=>$page,
	'footer'=>$footer
...
{
print('<p>On en apprend tout les jours !</p>');
